 ...
 * VERSION: refactor-reservas-v7 (FIX: _resolveStaffForSlotInternal factorizado
 *          para consumo de bookingSaga; sin cambios en el resto de contratos)
...
// =============================================================================
// [FIX v7] NUCLEO REUTILIZABLE DE RESOLUCION DE STAFF
// Consumido por bookingSaga.js (contrato objeto).
// =============================================================================

/**
 * Nucleo reutilizable de resolucion de staff para un slot (simple o dual).
 * @param {Object} params
 * @param {string} params.serviceId
 * @param {string} params.f1Start
 * @param {string} [params.f1End]
 * @param {string} [params.f2Start]
 * @param {string} [params.f2End]
 * @param {string} [params.requestedResourceId]
...
export async function _resolveStaffForSlotInternal(params = {}) {
    ...
    try {
        ...
        const isAnyStaff = !requestedResourceId || ["all", "any"].includes(requestedResourceId.toLowerCase());
